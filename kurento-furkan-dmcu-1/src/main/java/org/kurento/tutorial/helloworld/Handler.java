...
public class Handler extends TextWebSocketHandler
{
  ...
  private HubPort hubPortSrc = null;
                                     ...
                                     JsonObject jsonMessage)
  {
    ...
    if(pipeline == null){
      ...
      hubPortSrc = new HubPort.Builder(composite).build();
      hubPortSrc.connect(disUserSession.getWebRtcEndpoint());
    }
    ...
    disUserSession.getWebRtcEndpoint().connect(user.getWebRtcEndpoint());
